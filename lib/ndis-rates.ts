...
// Codes and caps match BACKEND_SPEC §4.1/§4.2 exactly (verified against seedCatalogue.ts).
export const NDIS_RATES_2026: Record<RateTier, NdisRateDef> = {
  ...
  SATURDAY: { tier: 'SATURDAY', itemCode: '01_014_0107_1_1', cap: 95.07, unit: 'Hour', label: 'Saturday' },
  SUNDAY: { tier: 'SUNDAY', itemCode: '01_013_0107_1_1', cap: 122.59, unit: 'Hour', label: 'Sunday' },
  HOLIDAY: { tier: 'HOLIDAY', itemCode: '01_012_0107_1_1', cap: 150.12, unit: 'Hour', label: 'Public Holiday' },
  TRAVEL: { tier: 'TRAVEL', itemCode: '01_799_0107_1_1', cap: 0.97, unit: 'KM', label: 'Travel' },
};

// User-selectable filing items. Codes MUST exist in the backend catalogue
// (resolveSupportItem rejects unknown codes with 422 INVALID_SUPPORT_ITEM).
export const SHIFT_SUPPORT_ITEMS: Array<{ code: string; label: string; allowsTravel: boolean }> = [
  ...
  { code: '01_013_0117_1_1', label: 'Community Participation', allowsTravel: true },
  { code: '01_002_0107_1_1', label: 'Household Tasks', allowsTravel: true },
];
